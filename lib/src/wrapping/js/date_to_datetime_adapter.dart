...
class JsDateToDateTimeAdapter extends TypedJsObject implements DateTime {
  static JsDateToDateTimeAdapter $wrap(JsObject jsObject) =>
      jsObject == null ? null : new JsDateToDateTimeAdapter.fromJsObject(jsObject);
  ...
  /// Create a new adapter from a [jsObject] of a Js Date object.
  JsDateToDateTimeAdapter.fromJsObject(JsObject jsObject) :
