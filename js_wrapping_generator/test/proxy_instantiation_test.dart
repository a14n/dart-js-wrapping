...
void main() {
  ...
  test('2 Class0 should be equals and have the same hashcode', () {
    final jsO = js.JsObject(js.context['Class0'] as js.JsFunction);
    final o1 = Class0.created(jsO);
    final o2 = Class0.created(jsO);
    expect(o1 == o2, true);
  ...
  test('Class0Alias and Class0 should be equals is proxyfiing the same js', () {
    final jsO = js.JsObject(js.context['Class0'] as js.JsFunction);
    final o1 = Class0.created(jsO);
    final o2 = Class0Alias.created(jsO);
    expect(o1 == o2, true);
    expect(o1.hashCode == o2.hashCode, true);
  });
