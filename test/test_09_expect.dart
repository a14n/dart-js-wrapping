...
set f6(List<Person> f6) => $unsafe['f6'] = f6 == null ? null : f6 is js.Serializable<js.JsObject> ? f6 : js.jsify(f6);
List<Person> get f6 => jsw.TypedJsArray.castListOfSerializables($unsafe['f6'], Person.cast);
set f7(List<String> f7) => $unsafe['f7'] = f7 == null ? null : f7 is js.Serializable<js.JsObject> ? f7 : js.jsify(f7);
