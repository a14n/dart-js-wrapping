...
@TestOn("browser")
library js_wrapping.test.proxy_methods_test;
...
main() {
  ...
  test('Class1.set2 should be instantiable with 1 argument and '
  ...
  test('Class1.set3 should be instantiable with 1 argument and '
